...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Event":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Event": %w`, err)
			}
			switch resolverName {
			...
			case "findEventByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findEventByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindEventByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Event": %w`, err)
				}
...
func entityResolverNameForEvent(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
